...
class ThirdPersonController(FrameAnimation3d):
    def __init__(self, position = (0, 10, 0), SPEED = 2, jump_height = 0.3, velocity = (0, 0, 0), MAXJUMP = 1,
        ...
        super().__init__(name="animation\\jetpack_waiting",fps=24,loop=True, autoplay=True, frame_times=120,texture="texture\\char")
